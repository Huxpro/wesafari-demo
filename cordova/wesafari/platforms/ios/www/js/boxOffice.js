...
define(['React', 'Chart', 'ReactChart', 'IScroll', 'Router', 'navBar', 'util', 'commonTable', 'movieDetail', 'datacenter', '../mock/apiBoxOffice'], function (React, Chart, ReactChart, IScroll, Router, NavBar, Util, CommonTable, MovieDetail, DataCenter, API) {
    'use strict';
    ...
    var BOModel = {
        ...
        getMovieByIndex: function getMovieByIndex(_index) {
            return this.getMovieList()[_index];
        },
        getTheBigBoard: function getTheBigBoard() {
    ...
    var BoxOffice = React.createClass({
        ...
        render: function render() {
            ...
            return React.createElement(
                'div',
                { className: 'contentViewWithFooter bo-scroller ' + this.props.active
                },
                React.createElement(
                    'ul',
                    { className: 'scroller' },
