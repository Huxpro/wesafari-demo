...
gulp.task('serve',  function(){
    ...
    console.log("server running at port: 9004");
})


// cordova
gulp.task('cordova', ['css', 'jsx'],  function(){
    exec('npm run cordova-src', function(error, stdout, stderr){
    })
})
...
gulp.task('watch', ['css', 'jsx', 'serve' ], function(){
    // watch JSX and SASS
    gulp.watch('src/js/jsx/*.jsx', ['jsx', 'cordova']);
    gulp.watch('src/css/*.scss', ['css', 'cordova']);
})
